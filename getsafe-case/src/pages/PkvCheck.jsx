...
const ERGEBNISSE = {
  fit: {
    ...
    text: "Deine Angaben sprechen dafür: Wechselberechtigung, Alter, Familiensituation und Einkommensplanung passen zum typischen PKV-Profil. Ob es sich wirklich rechnet, hängt jetzt an Tarif, Selbstbehalt und Gesundheitsprüfung – genau das klären wir in der Beratung.",
  ...
  pruefen: {
    ...
    text: "Bei dir sprechen Punkte dafür und dagegen. Ein Wechsel ist eine Entscheidung für Jahrzehnte – die solltest du nicht auf Basis eines Online-Checks treffen, sondern mit einer ehrlichen Rechnung über beide Systeme.",
    cta: "kostenlose 15-min Beratung buchen",
  },
  kritisch: {
    ...
    text: "Familie, Einkommensplanung oder Alter sprechen bei dir eher gegen einen Wechsel – auch wenn Vergleichsseiten das gern klein schreiben. Was sich stattdessen fast immer lohnt: innerhalb der GKV die Kasse wechseln. Gleiche Grundleistungen, bis zu 770 € weniger pro Jahr.",
  ...
  gate: {
    ...
    text: "Als Angestellte:r brauchst du ein Jahresbrutto über der Versicherungspflichtgrenze von 77.400 € (2026). Bis dahin gilt: Innerhalb der GKV wechseln lohnt sich fast immer – gleiche Grundleistungen, bis zu 770 € Ersparnis pro Jahr.",
    cta: "Zum Kassen-Check (GKV)",
  },
  bald: {
    chip: "bald relevant",
    ...
    text: "Du liegst knapp unter der Versicherungspflichtgrenze. Mit der nächsten Gehaltserhöhung oder einem Jobwechsel kann sich das ändern – und 2027 werden die Grenzwerte voraussichtlich außerordentlich angehoben. Wir erinnern dich, wenn es für dich so weit ist.",
  ...
  student: {
    ...
    text: "Zum Studienstart kannst du dich einmalig von der GKV-Pflicht befreien lassen – diese Entscheidung gilt fürs ganze Studium und will gut überlegt sein. Das klären wir am besten kurz persönlich.",
    cta: "kostenlose 15-min Beratung buchen",
  },
};
        ...
        <div className="mx-auto" style={{ maxWidth: 640 }}>
          {!ergebnis && (
            <>
              ...
              <p className="text-base mb-8" style={{ color: C.inkSoft }}>
                Ob du wechseln darfst, ob es sich lohnen kann – und worauf du achten
                musst, bevor du entscheidest. Ehrlich gerechnet, ohne Verkaufsdruck.
              </p>
                  ...
                  <div className="space-y-2.5">
                    {aktuelle.optionen.map((o) => (
                      <button
                        ...
                        className="w-full text-left rounded-2xl px-4 py-3.5 font-semibold"
          ...
          {ergebnis && E && (
            ...
            >
              ...
              <button
                className="w-full rounded-full py-4 font-bold text-white mb-3"
                style={{ background: C.ink }}
                onClick={() => {
              ...
              <button
                onClick={neustart}
                className="w-full text-sm font-semibold underline underline-offset-2"
                style={{ color: C.inkSoft }}
              >
                Check neu starten
              </button>
          ...
          >
            <strong>Ehrlicher Hinweis:</strong> Ein Wechsel in die PKV ist nicht
            automatisch die bessere Wahl. Gerade bei größerer Familie, unsicherem
            Einkommen oder geplanter Rückkehr in die GKV passt die gesetzliche Lösung
            langfristig oft besser. Deshalb zeigen wir dir beide Seiten – nicht nur
            die Vorteile.
          </div>
        </div>
      </main>
