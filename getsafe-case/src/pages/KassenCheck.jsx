...
function Rechner() {
  ...
  const calc = useMemo(() => {
    ...
    const elapsed = Math.min(Math.max((now - yearStart) / (yearEnd - yearStart), 0), 1);
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="text-xs font-semibold mt-2.5 underline underline-offset-2"
          ...
          <>
            ...
            {brutto * 12 > 77400 && (
              <div
                ...
                style={{ background: C.card }}
              >
                <strong>Gut zu wissen:</strong> Mit über 77.400 € Jahresbrutto
                (Versicherungspflichtgrenze 2026) steht dir auch die{" "}
                <strong>private Krankenversicherung</strong> offen. Ob sie zu dir
                passt, zeigt dir der <a href="/pkv-check" className="underline font-bold">PKV-Fit-Check</a> in 5 Fragen.
              </div>
            )}
          </>
        ) : (
  ...
  return (
    ...
    >
      ...
      >
        ...
        Kassen-Check 2026: Die Zusatzbeiträge sind gestiegen – prüfe dein
        Sparpotenzial | Jetzt checken
      </div>
      ...
      <header className="px-5 pt-10 pb-16 sm:pt-16 sm:pb-24">
        <div
          className="mx-auto flex flex-col lg:flex-row gap-12 lg:items-center"
          style={{ maxWidth: 1080 }}
        >
          <div className="flex-1">
            ...
            <a
              href="#rechner"
              className="inline-block rounded-full px-8 py-4 font-bold text-white mb-6"
              style={{ background: C.ink }}
            >
              Jetzt checken
            </a>
            ...
            {[
              {
                ...
                d: "Der durchschnittliche Zusatzbeitrag ist auf 2,9 % gestiegen. Die Spanne zwischen den Kassen: 2,18 % bis 4,39 % – bei identischen Grundleistungen.",
              },
              {
                chip: "dein Recht",
                t: "Erhöhung? Sofort raus.",
                d: "Erhöht deine Kasse den Beitrag, hast du ein Sonderkündigungsrecht – die 12-Monats-Bindung fällt weg. Genau jetzt ist der beste Moment zum Wechseln.",
              },
              {
                chip: "ohne Papierkram",
                t: "5 Minuten, fertig",
                d: "Du beantragst nur die neue Mitgliedschaft. Die neue Kasse kündigt bei der alten, dein Arbeitgeber bekommt alles elektronisch. Lückenlos versichert.",
              },
            ].map((s, i) => (
              <div
                key={i}
            ...
            {[
              {
                ...
                a: "Nein. Rund 95 % der Leistungen sind gesetzlich festgelegt und überall identisch. Unterschiede gibt es nur bei Extras wie Zahnreinigung oder Bonusprogrammen – die checkst du vor dem Wechsel.",
              },
              {
                q: "Kann mich eine Kasse ablehnen?",
                a: "Nein. Jede gesetzliche Kasse muss dich aufnehmen – egal wie alt du bist oder welche Vorerkrankungen du hast. Das ist dein gesetzliches Kassenwahlrecht.",
              },
              {
                q: "Wie aufwendig ist der Wechsel wirklich?",
                a: "Antrag bei der neuen Kasse stellen – fertig. Sie kündigt bei deiner alten, eine Versicherungslücke ist gesetzlich ausgeschlossen. Deinem Arbeitgeber reicht eine kurze Info.",
              },
              {
                q: "Wann kann ich wechseln?",
                a: "Regulär nach 12 Monaten Mitgliedschaft mit zwei Monaten Frist. Bei einer Beitragserhöhung sofort per Sonderkündigungsrecht – unabhängig von der Bindungsfrist.",
              },
            ].map((f, i) => (
